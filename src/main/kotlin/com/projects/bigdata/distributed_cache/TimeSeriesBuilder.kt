...
fun getDatesBetween(startDate: LocalDate, endDate: LocalDate): Stream<LocalDate> = IntStream.iterate(0) { it + 1 }.limit(ChronoUnit.DAYS.between(startDate, endDate)).mapToObj { startDate.plusDays(it.toLong()) }
