...
public final class StreamingRunner {
	...
	public static void main(final String[] args) throws Exception {
    	...
    	final StreamingAppParameters sap = new StreamingAppParameters(p.getProperty("streamingHost1"), Integer.valueOf(p.getProperty("streamingPort1")),
    			...
    			Integer.valueOf(p.getProperty("processingTimeoutMilliseconds")));
	...
	public static AbstractStreaming getStreamingApp(final String[] args, final StreamingAppParameters sap) {
		return (args == null || args.length == 0 ? new TradesAnalytics(sap) : StreamingAppFactory.getStreamingApp(StreamingLineType.valueOf(args[0]), sap));
	}
}
